...
<div class="fieldcontain ${hasErrors(bean: userInstance, field: 'ppp', 'error')} required">
	<label for="ppp">
		<g:message code="user.ppp.label" default="Ppp" />
		<span class="required-indicator">*</span>
	</label>
...
<div class="fieldcontain ${hasErrors(bean: userInstance, field: 'ssn', 'error')} required">
	<label for="ssn">
		<g:message code="user.ssn.label" default="Ssn" />
		<span class="required-indicator">*</span>
	</label>
...
<div class="fieldcontain ${hasErrors(bean: userInstance, field: 'street', 'error')} required">
	<label for="street">
...
<div class="fieldcontain ${hasErrors(bean: userInstance, field: 'telephone', 'error')} required">
	...
	<g:textField name="telephone" required="" value="${userInstance?.telephone}"/>
