		...
		<div id="list-user" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="dateOfLastAct" title="${message(code: 'user.dateOfLastAct.label', default: 'Date Of Last Act')}" />
				...
				<g:each in="${userInstanceList}" status="i" var="userInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:formatDate date="${userInstance.dateOfLastAct}" /></td>
